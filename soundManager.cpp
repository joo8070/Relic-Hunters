...
int soundManager::getLength(string KeyName)
{
	...
	int count = 0;
	for (auto it = _mTotalSounds.begin(); it != _mTotalSounds.end(); it++, count++)
	{
		if (KeyName == it->first)
		{
			break;
...
int soundManager::getCurrentLength(string KeyName)
{
...
void soundManager::setCurrentLength(string KeyName, int ms)
{
	int count = 0;
	for (auto it = _mTotalSounds.begin(); it != _mTotalSounds.end(); it++, count++)
	{
